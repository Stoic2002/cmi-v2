            ...
            <div className="layout-container flex h-full grow flex-col z-10 relative items-center justify-center p-4 sm:p-8">
                <div className="glass-panel w-full max-w-[480px] rounded-xl p-8 sm:p-10 flex flex-col items-center">
                    ...
                    <form onSubmit={handleSubmit} className="w-full flex flex-col gap-5">
                        <div className="group">
                            <label className="block text-gray-500 text-sm font-medium mb-2 ml-1">Full Name</label>
                    ...
                    <div className="text-center mt-8">
                        <p className="text-gray-500">
                            ...
                            <Link className="text-gray-900 font-semibold hover:text-primary transition-colors relative after:content-[''] after:absolute after:-bottom-1 after:left-0 after:w-0 after:h-[1px] after:bg-primary hover:after:w-full after:transition-all duration-300" to="/login">
                                Login here
                            </Link>
                        </p>
                    </div>
